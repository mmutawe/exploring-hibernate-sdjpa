...
import com.mmutawe.explore.hibernate.sdjpa.spring.data.jpa.dao.AuthorDao;
...
public class AuthorDaoTest {
    ...
    @Test
    void testGetAuthorByFullNameNotFound(){
        assertThrows(EntityNotFoundException.class,
                () -> authorDao.getAuthorByFullName("NOT","FOUND"));
    }
    ...
    void testDeleteAuthor(){
        ...
        assertThrows(JpaObjectRetrievalFailureException.class, () -> authorDao.getAuthorById(authorId));
    }
